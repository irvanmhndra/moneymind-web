...
import { budgetService, type CreateBudgetData } from '../../services/budgets';
...
const AddBudgetForm: React.FC<AddBudgetFormProps> = ({ onSuccess, onClose }) => {
  ...
  const handleInputChange = (field: keyof CreateBudgetData, value: string | number | string[] | number[]) => {
